...
background_image = Image.open(r"Snake game\images\background.png")
...
def draw():
    ...
    if (game_over):
        canvas.create_text(WINDOW_WIDTH/2, WINDOW_HEIGHT/2, font = "Georgia 20", text = f"Game Over: {score}", fill = "white")
    else:
